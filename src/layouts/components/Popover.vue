<template>
  <div class="popover">
    <transition :name="transition">
      <div
        ref="popper"
        class="popover-content one-border"
        :class="locationClass"
        v-show="showPopper"
...
export default {
  ...
  methods: {
    doToggle() {
      ...
      if (
        this.showPopper &&
        document.body !== this.$refs.popper.parentElement
      ) {
      ...
      this.$nextTick(() => {
        ...
        switch (this.placement) {
          ...
          case "bottom":
            ...
            popperTag.style.left = `${
              clientWidth / 2 - (tb_left - (left + width / 2))
            }px`;
            break;
          case "left":
